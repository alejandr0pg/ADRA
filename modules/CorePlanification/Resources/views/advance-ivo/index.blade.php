...
@section('title')
    {{ trans('coreplanification::advance-ivo.title') }}
@stop

@section('content')
    <div class="row page-titles">
        <div class="col-md-7 col-12 align-self-center">
            <h3 class="text-themecolor">{{ trans('coreplanification::advance-ivo.title') }}</h3>
            <ol class="breadcrumb">
 ...
 <div class="collapse" id="objetivo{{$objetivo->id}}"  data-id="objetivo{{$objetivo->id}}">
                                               ...
                                               @if(isset($_GET['agency']))   <a href="{{url('admin/planification/advance-ivo')}}?agency={{$_GET['agency']}}&index={{$indicador->id}}" > @else   @endif  {{$indicador->descripcion}} </a>
                                            ...
                                            <label>
                                              <form id="dc-form4" action="{{route('indicador_core_update')}}" method="POST">
                                                {{csrf_field()}}
                                                        ...
                                                        @endif
                                                        <input type="hidden" name="id" value="{{$_GET['index']}}">
                                                <input disabled="" onclick="$('#dc-form4').submit()" type="checkbox" @if($index->status_core == 4)  checked=""  @endif ><span class="lever"></span>{{ trans('coreplanification::ejecuter.completo_con_documentacion') }}</label> </form>
                                        </div>
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-8">
                                              <form id="mensaje-form" action="{{route('mensaje_send.store')}}" method="POST" >
                                                ...
                                                <textarea disabled="" name="mensaje" placeholder="Type your message here" class="form-control b-0"></textarea>     
                                               </form>
                                            </div>
                                            <div class="col-4 text-right">
                                                <button  disabled="" onclick="$('#mensaje-form').submit()" type="button" class="btn btn-info btn-circle btn-lg"><i class="fas fa-paper-plane"></i> </button>
                                            </div>
...
window.location.replace("{{url('admin/planification/advance-ivo')}}?agency="+redir)
    }
    </script>
