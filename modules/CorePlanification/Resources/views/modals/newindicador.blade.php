<div class="modal fade modal-indicador" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="mySmallModalLabel">
                    {{ trans('coreplanification::register.add_indicador') }}
                </h4>
            ...
            <div class="modal-body"> 
                <form id="indicador-form" 
                    ...
                    method="POST">
                    <input id="indicador_id" type="hidden" name="objetivo_id" value="1">
                    @csrf
            ...
            <div class="modal-footer">
                ...
                <button onclick="event.preventDefault();document.getElementById('indicador-form').submit();" type="button" class="btn btn-danger waves-effect waves-light">{{ trans('currency::currencies.modal.save') }}</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
