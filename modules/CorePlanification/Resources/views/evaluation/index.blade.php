...
@section('title')
    {{ trans('coreplanification::evaluation.title') }}
@stop
@section('styles')
...
@section('content')
    <div class="row page-titles">
        <div class="col-md-7 col-12 align-self-center">
            <h3 class="text-themecolor">{{ trans('coreplanification::evaluation.title') }}</h3>
            <ol class="breadcrumb">
 ...
 <div class="collapse" id="objetivo{{$objetivo->id}}"  data-id="objetivo{{$objetivo->id}}">
                                               ...
                                               @if(isset($_GET['agency']))   <a href="{{url('admin/planification/evaluation')}}?agency={{$_GET['agency']}}&index={{$indicador->id}}" > @else   @endif  {{$indicador->descripcion}} </a>
                                   ...
                                   <div class="switch">
                                                ...
                                                <form id="dc-form1" action="{{route('indicador_core_update')}}" method="POST">
                                                    {{csrf_field()}}
                                                      ...
                                                      <input disabled="" onclick="$('#dc-form1').submit()" type="checkbox" @if($index->status_core == 1 )  checked=""  @endif ><span class="lever"></span>{{ trans('coreplanification::ejecuter.sin_plan') }}</label>
                                                </form>
                                  ...
                                  <div class="switch">
                                        <form id="dc-form2" action="{{route('indicador_core_update')}}" method="POST">
                                                    {{csrf_field()}}
                                                      ...
                                                      <label>
                                                        <input disabled="" type="hidden" name="id" value="{{$_GET['index']}}">
                                                <input disabled="" onclick="$('#dc-form2').submit()"  type="checkbox" @if($index->status_core == 2 )  checked=""  @endif ><span class="lever"></span>{{ trans('coreplanification::ejecuter.fase_inicial') }}</label>
                                    ...
                                    <input disabled="" onclick="$('#dc-form3').submit()"  type="checkbox" @if($index->status_core == 3 )  checked=""  @endif ><span class="lever"></span>{{ trans('coreplanification::ejecuter.fase_desarrollo') }}</label>
                                            </form>
                                        </div>
                                            ...
                                            <label>
                                              <form id="dc-form4" action="{{route('indicador_core_update')}}" method="POST">
                                                {{csrf_field()}}
                                                        ...
                                                        @endif
                                                        <input type="hidden" name="id" value="{{$_GET['index']}}">
                                                <input s disabled="" onclick="$('#dc-form4').submit()" type="checkbox" @if($index->status_core == 4)  checked=""  @endif ><span class="lever"></span>{{ trans('coreplanification::ejecuter.completo_con_documentacion') }}</label> </form>
                                        </div>
                                              ...
                                              <form id="ev-form1" action="{{route('indicador_core_update')}}" method="POST">
                                                    {{csrf_field()}}
                                                     @if($index->status_evaluation ==  1)
                                                        ...
                                                        @endif
                                                        <input type="hidden" name="id" value="{{$_GET['index']}}">
                                                <input onclick="$('#ev-form1').submit()" type="checkbox"  @if($index->status_evaluation == 1)  checked=""  @endif type="checkbox"><span class="lever"></span>{{ trans('coreplanification::ejecuter.sin_mdv') }}</label>
                                              ...
                                              <form id="ev-form2" action="{{route('indicador_core_update')}}" method="POST">
                                                    {{csrf_field()}}
                                                     @if($index->status_evaluation==  2)
                                                        ...
                                                        @endif
                                                        <input type="hidden" name="id" value="{{$_GET['index']}}">
                                                <input onclick="$('#ev-form2').submit()" @if($index->status_evaluation == 2 )  checked=""  @endif type="checkbox" ><span class="lever"></span>{{ trans('coreplanification::ejecuter.insuficiente') }}</label>
                                              </form>
                                        </div>
                                            ...
                                            <label>
                                                    ...
                                                    {{csrf_field()}}
                                                     @if($index->status_evaluation ==  3)
                                                        ...
                                                        @endif
                                                        <input type="hidden" name="id" value="{{$_GET['index']}}">
                                                <input onclick="$('#ev-form3').submit()"  type="checkbox" @if($index->status_evaluation == 3 )  checked=""  @endif ><span class="lever"></span>{{ trans('coreplanification::ejecuter.sastifactorio') }}</label>
                                              </form>
                                        </div>
                                              ...
                                              <form id="ev-form4" action="{{route('indicador_core_update')}}" method="POST">
                                                    {{csrf_field()}}
                                                     @if($index->status_evaluation ==  4)
                                                        ...
                                                        @endif
                                                        <input type="hidden" name="id" value="{{$_GET['index']}}">
                                                <input type="checkbox" @if($index->status_evaluation == 4 )  checked=""  @endif onclick="$('#ev-form4').submit()" ><span class="lever"></span>{{ trans('coreplanification::ejecuter.excelente') }}</label>
                                              </form>
                                        </div>
...
window.location.replace("{{url('admin/planification/evaluation')}}?agency="+redir)
    }
    </script>
